...
export const InventoryDashboard: React.FC = () => {
  const { inventory, restockInventory, menuItems, toggleSoldOut } = useApp();
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-500">
              Ingredient-level tracking, real-time recipe depletion & 86'd menu controls
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800/60">
              {filteredInventory.map((item) => {
                ...
                return (
                  <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-[#1a1a1f] transition-colors">
                    <td className="py-3 px-3">
                      <span className="font-bold text-[#111111] dark:text-[#f8f7f4]">
                        {item.name}
                      </span>
                    </td>
                    ...
                    <td className="py-3 px-3 font-mono font-bold text-sm">
                      <span className={isCritical ? 'text-red-500' : isLow ? 'text-amber-500' : 'text-gray-900 dark:text-white'}>
                    ...
                    <td className="py-3 px-3 font-mono text-gray-600 dark:text-gray-400">
                      {formatPhp(item.unitCostPhp)}/{item.unit}
                    </td>
